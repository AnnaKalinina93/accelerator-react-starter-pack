# Учебный проект по продаже гитар

ТЗ: нужно было реализовать страницу каталога, также страницу описания карточки. Поиск гитар, сортировку, фильтрацию , добавление товаров в корзину, пагинацию, и изменение товаров в корзине применение промокода. Данные получать с сервера.

Проект реализован на TS при помощи библиотеки react/ redux-tolkit. Проект отрисован с помощью функциональных компонентов с применением хуков. Все изменения данных происходили в сторе. Также были применено  thunks  для редиректа.
